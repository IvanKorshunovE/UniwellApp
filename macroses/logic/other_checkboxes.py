from ..models import AfraidNotCancel, NoFreeTrial, NoTime, BadMeals, BadWorkouts
...
def bad_workouts(sorted_data):
    ...
    if True in checkbox_list:
        if 'MM' in sorted_data[2]:
            ...
            if sorted_data[12] == False: # If BAD MEALS CHECKBOX is NOT checked
                mm_part3 = BadWorkouts.objects.get(id=4)  # If you don't like a suggested exercise, click "Swap" next to it to have it replaced.
                ...
                if 'upsell' in sorted_data[2]:
                    ...
                    mm_part3_1 = '!!! USER DOES NOT HAVE MEAL PLAN !!!'
                bad_workouts_part.append(mm_part3_1)
                if 'upsell' in sorted_data[2]:
                    mm_part3_5 = BadMeals.objects.get(id=4)
                else:
                    mm_part3_5 = '!!! USER DOES NOT HAVE MEAL PLAN !!!'
